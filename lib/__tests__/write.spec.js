...
describe('write', function () {
  ...
  it('should put complex array values', function () {
    ...
    var data = (0, _write2.default)('cat[0].dog[3].rabbit.fox', 'wolf', oldState);
    ...
    (0, _expect2.default)(data.cat[0].dog[3]).toBeA('object');
    (0, _expect2.default)(data.cat[0].dog[3].rabbit).toBeA('object');
    (0, _expect2.default)(data.cat[0].dog[3].rabbit.fox).toBe('wolf');
    (0, _expect2.default)(oldState.cat[0].dog[3].rabbit.fox).toBe('abc');
